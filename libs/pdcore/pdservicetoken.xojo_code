...
Protected Class pdservicetoken
	...
	#tag Method, Flags = &h0
		Function Create() As pdOutcome
		  ...
		  init.Append("objidx INTEGER PRIMARY KEY AUTOINCREMENT , ")
		  init.Append("name TEXT NOT NULL , ")
		  init.Append("friendlyname TEXT NOT NULL , ")
		  init.Append("description TEXT , ")
		  init.Append("comments TEXT , ")
		  init.Append("tokenissued DATETIME NOT NULL , ")
		  init.Append("organization TEXT NOT NULL , ")
		  init.Append("host TEXT NOT NULL , ")
		  init.Append("port INTEGER NOT NULL , ")
		  init.Append("database TEXT NOT NULL , ")
		  init.Append("username TEXT , ")
		  init.Append("password TEXT , ")
		  init.Append("secure BOOLEAN NOT NULL , ")
		  init.Append("ssl_key TEXT , ")
		  init.Append("ssl_certificate TEXT , ")
		  init.Append("ssl_ca TEXT )")
